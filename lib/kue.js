...
Queue.prototype.process = function( type, n, fn ) {
  ...
  // @tobalsgithub / TC
  // Changing this up from how it works in the official version of kue
  // Don't want to start timers on every single process and every single job type
  // Want to be able to control this
  //this.setupTimers();
};
